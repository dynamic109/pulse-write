...
//   return (
//     <div
//       className="bg-card border border-border rounded-xl w-full overflow-hidden hover:shadow-md transition-shadow cursor-pointer"
//       onClick={onPostClick}
//     >
//       {/* MAIN CONTENT */}
//       <div className="flex flex-col md:flex-row gap-4 p-4">
//         {/* LEFT — IMAGE */}
//         <div className="flex-shrink-0 w-full md:w-1/3 h-48 md:h-auto overflow-hidden rounded-md">
//           <img
//             src={post.image}
//             alt={post.description}
//             className="w-full h-full object-cover"
